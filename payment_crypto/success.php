...
<?php
$sql = "UPDATE crypto SET payment_status='PAID' WHERE code LIKE $code";
if ($connection->query($sql) === TRUE) {
    $sub = "NO REPLY - PAYMENT SUCCESSFUL";
    $msg = "
        Mr/Ms. $name,
        <br>
        Congratulations! You have been successfully registered for Crypto Workshop + Simulation Games.
        <br>
